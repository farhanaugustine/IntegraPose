...
<div class="landing-showcase-grid">
  ...
  <div class="landing-showcase-card">
    ...
    <p>
      <strong><a href="plugins/behavior-scope/">BehaviorScope Toolkit</a></strong> —
      train an LSTM behavior classifier on Tab 7's exported clips.<br>
      <strong><a href="plugins/tandem-yolo-toolkit/">Tandem YOLO Toolkit</a></strong> —
      coupled detector + temporal classifier in a single workflow.
    </p>
  </div>
  <div class="landing-showcase-card">
