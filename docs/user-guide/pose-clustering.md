...
- Hand off **named, organized clip folders** to a downstream classifier (BehaviorScope, a YOLO clip trainer, manual review, etc.).
...
Each step shows a 3 × 3 grid of triptychs — three frames per bout
...
If you want to feed your sub-behaviors into BehaviorScope or another
classifier trainer, click **Export Sub-cluster Clips**. The result is a
