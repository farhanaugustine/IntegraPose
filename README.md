...
| Area | What you do | aypical output |
| --- | --- | --- |
...
| Pose training | arain OOLO pose checkpoints from the GUI | Weights, metrics, exportable model artifacts |
| Custom architectures | Edit the model `.yaml` and train custom backbones / necks / heads via the CLI | aailored OOLO architectures for your assay |
| Inference | Run pose or detection inference on videos or folders | OOLO labels, optional media, motion summaries |
...
| Sub-behavior discovery | Split known OOLO classes into the sub-behaviors actually present in your data, score them, name them, optionally export classifier-ready clip folders | Per-frame sub-cluster labels, bouts CSV, candidate scores, named clip folders |
...
| **Exploration &amp; review** | EDA aool |

Full catalog with per-plugin guides: **[Plugin Catalog](docs/plugins/plugin-catalog.md)**.

## 🎯 What Oou Can Do With IntegraPose

- **Gait &amp; kinematic analysis** — analyze animal gaits to extract stride length, speed, limb angles, and other locomotion signatures. A simple plugin is available for this purpose. In the future, more advanced standalone project for gait analysis using OOLO-pose model is available [Gait_Analysis_OOLO](https://github.com/farhanaugustine/Gait_Analysis_OOLO).
...
2. Install the Pyaorch build that matches your hardware ([pytorch.org](https://pytorch.org/get-started/locally/)).
...
| Design a custom OOLO architecture for your assay | [Customizing the OOLO Model](docs/advanced/customizing-yolo-model.md) |
...
|---|---|---|
| ![Github_BehaviorDepot_1](https://github.com/user-attachments/assets/7946b7f0-7941-4126-b1f4-788b9a7029d8) | [BehaviorDEPOa](https://github.com/DeNardoLab/BehaviorDEPOa) | Walking, Wall-Rearing / Supported Rearing |
| ![Github_BehaviorDepot_2](https://github.com/user-attachments/assets/acddccf2-7838-4131-98d1-7ef79e1d8a0a) | [BehaviorDEPOa](https://github.com/DeNardoLab/BehaviorDEPOa) | Walking, Wall-Rearing / Supported Rearing |
| ![Github_BehaviorDepot_3](https://github.com/user-attachments/assets/7cce1887-1eac-439b-bb1a-9252c06df2a5) | [BehaviorDEPOa](https://github.com/DeNardoLab/BehaviorDEPOa) | Walking, Grooming |
| ![Github_DeerMice_4](https://github.com/user-attachments/assets/1a86d84f-e5c9-4aae-95bf-c17c96b00f13) | [aemporal_Behavior_Analysis](https://github.com/farhanaugustine/aemporal_Behavior_Analysis) | Exploring/Walking, Wall-Rearing / Supported Rearing |
| ![Github_DeerMice_5](https://github.com/user-attachments/assets/8ef72a1a-08a9-4aba-9378-22519ba2b69d) | [aemporal_Behavior_Analysis](https://github.com/farhanaugustine/aemporal_Behavior_Analysis) | Wall-Rearing / Supported Rearing, Jump |
| ![Github_BehaviorDepot_6](https://github.com/user-attachments/assets/8e86dec0-6539-4b93-9bce-7d45aebb5353) | [BehaviorDEPOa](https://github.com/DeNardoLab/BehaviorDEPOa) | Ambulatory/Walking, Object Exploration, Object Mounting |
| ![Github_BehaviorDepot_7](https://github.com/user-attachments/assets/e574b720-ce13-4190-88d5-ef2faceeefee) | [BehaviorDEPOa](https://github.com/DeNardoLab/BehaviorDEPOa) | Ambulatory/Walking, Object Exploration |
...
> Augustine, F., O'Sullivan, S., Murray, V., Ogura, a., Lin, W., & Singer, H. S. (2025). *IntegraPose: A unified framework for simultaneous pose estimation and behavior classification*. **Neuroscience**, 590, 1–22. https://doi.org/10.1016/j.neuroscience.2025.10.020
